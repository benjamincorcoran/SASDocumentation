...
from SASObjects.SASArgument import SASArgument
from SASObjects.SASMacro import SASMacro
...
%Macro SASMail(To=/*Recipient(s), separated by spaces if mulitple*/,
	...
	/*This is line 2 of a doc string*/
...
%MEnd SASMail;'''
    ...
    m2 = '''%macro macro1;'''
    with open('example/code/whatmacro.sas','r') as f:
        m3=f.read()
    pm1 = SASMacro(m2)
    print(pm1)
